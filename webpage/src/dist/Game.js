...
var Game = /** @class */ (function (_super) {
    ...
    function Game(connection) {
        ...
        _this.connection.on('init', function (_a) {
            var playerTickRate = _a.playerTickRate, token = _a.token;
    ...
    Game.prototype.setup = function () {
        ...
        this.connection.on('world-update', function (updatedTiles) {
            updatedTiles.forEach(function (tile) {
                ...
                _this.world.worldTiles[tile.tileIndex] = tile.tile;
                ...
                _this.world.tileLayer.rect(((tile.tileIndex % _this.world.width) - 1) *
                    _this.TILE_WIDTH, Math.floor(tile.tileIndex / _this.world.width) *
                    _this.TILE_HEIGHT, _this.TILE_WIDTH * 3, _this.TILE_HEIGHT);
                _this.world.tileLayer.rect((tile.tileIndex % _this.world.width) * _this.TILE_WIDTH, (Math.floor(tile.tileIndex / _this.world.width) - 1) *
                    _this.TILE_HEIGHT, _this.TILE_WIDTH, _this.TILE_HEIGHT * 3);
                _this.world.tileLayer.noErase();
    ...
    Game.prototype.mousePressed = function () {
        ...
        if (this.mouseX > 2 * this.upscaleSize &&
            ...
            if (this.pickedUpSlot === -1) {
                ...
                ], this.hotBar[this.pickedUpSlot] = _a[0], this.hotBar[clickedSlot] = _a[1];
        ...
        if (this.pickedUpSlot !== -1) {
            if (this.mouseX > 2 * this.upscaleSize &&
                ...
                _a = [
                    ...
                    this.hotBar[this.pickedUpSlot],
                ], this.hotBar[this.pickedUpSlot] = _a[0], this.hotBar[releasedSlot] = _a[1];
                this.pickedUpSlot = -1;
            }
            else {
    ...
    Game.prototype.drawTile = function (tileIndex) {
        if (this.world.worldTiles[tileIndex] !== 0) {
            ...
            var tile = Tiles_1.Tiles[this.world.worldTiles[tileIndex]];
            ...
            if (tile.connected && tile.texture instanceof TileResource_1["default"]) {
                ...
                var topTileBool = Math.floor((tileIndex - this.world.width) / this.world.width) <= 0 ||
                    this.world.worldTiles[tileIndex - this.world.width] !== 0;
                var leftTileBool = tileIndex % this.world.width === 0 ||
                    this.world.worldTiles[tileIndex - 1] !== 0;
                var bottomTileBool = Math.floor((tileIndex - this.world.width) / this.world.width) >=
                    this.world.height - 1 ||
                    this.world.worldTiles[tileIndex + this.world.width] !== 0;
                var rightTileBool = tileIndex % this.world.width === this.world.width - 1 ||
                    this.world.worldTiles[tileIndex + 1] !== 0;
                // convert 4 digit binary number to base 10
                var tileSetIndex = 8 * +topTileBool +
                    4 * +rightTileBool +
                    2 * +bottomTileBool +
                    +leftTileBool;
    ...
    Game.prototype.pickUpItem = function (itemStack) {
        for (var i = 0; i < this.hotBar.length; i++) {
            ...
            if (item.item === itemStack.item &&
                ...
                var remainingSpace = item.item.maxStackSize - item.stackSize;
